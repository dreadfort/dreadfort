...
from dreadfort.data.model.worker import Worker, SystemInfo

_db_handler = MagicMock()

from dreadfort.data.model import worker_util
...
class WhenTestingWorkerUtil(unittest.TestCase):
    ...
    def test_create_worker_calls_db_put(self):
        ...
        with patch('dreadfort.data.model.worker_util._db_handler.put',
                   put_method):
    ...
    def test_find_worker_returns_worker(self):
        ...
        with patch('dreadfort.data.model.worker_util._db_handler.find_one',
                   find_one_method):
    ...
    def test_save_worker(self):
        ...
        with patch('dreadfort.data.model.worker_util._db_handler.update',
                   update_method):
    ...
    def test_retrieve_all_workers(self):
        ...
        with patch('dreadfort.data.model.worker_util._db_handler.find',
                   find_method):

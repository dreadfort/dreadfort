...
from dreadfort.data.model.tenant import EventProducer, Tenant
...
class WhenTestingFindMethods(unittest.TestCase):
    ...
    def test_find_tenant_returns_instance(self):
        ...
        with patch('dreadfort.data.model.tenant_util.retrieve_tenant',
    ...
    def test_find_tenant_creates_new_tenant_on_no_tenant_found(self):
        ...
        with patch('dreadfort.data.model.tenant_util.retrieve_tenant',
                ...
                'dreadfort.data.model.tenant_util.create_tenant',
                create_tenant_call):
    ...
    def test_create_tenant(self):
        ...
        with patch('dreadfort.data.model.tenant_util._db_handler',
                   self.ds_handler), patch(
                'dreadfort.data.model.tenant_util.'
    ...
    def test_create_event_producer(self):
        ...
        with patch(
                'dreadfort.data.model.tenant_util._db_handler',
                self.ds_handler), \
            patch(
                'dreadfort.data.model.tenant_util.'
            ...
            patch(
                'dreadfort.data.model.tenant_util.save_tenant',
                save_tenant_call):
    ...
    def test_delete_event_producer(self):
        save_tenant_call = MagicMock()
        with patch('dreadfort.data.model.tenant_util.save_tenant',
                   save_tenant_call):

...
from dreadfort.personas.common.publish_stats import ConfigCache
from dreadfort.personas.common.publish_stats import publish_worker_stats
...
class WhenTestingPublishStats(unittest.TestCase):
    ...
    def test_http_request_called(self):
        with patch.object(
                ...
                'dreadfort.personas.common.publish_stats.http_request',
                self.http_request), patch(
                'dreadfort.personas.common.publish_stats.get_config',
